...
if (isset($_POST['add'])) {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO violating (`campus_no`,`room_no`,`date`,`time`,`period`,`year`,`semester`,`course_no`,`section_seq`,`violate_case`,`confirm`,`monetor_member_id1`,`monetor_member_id2`,`com_member_id1`,`student_id`) VALUES" .
            "('$campus_no','$room_no','$date','$time','$period','$year','$semester','$course_no','$section_seq','$violate_case','$confirm','$monetor_member_id1','$monetor_member_id2','$com_member_id1','$student_id')";
