...
if (isset($_POST['add'])) {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO forbidden (`campus_no`,`room_no`,`date`,`time`,`period`,`year`,`semester`,`course_no`,`section_seq`,`reason`,`com_member_id1`,`student_id`) VALUES" .
            "('$campus_no','$room_no','$date','$time','$period','$year','$semester','$course_no','$section_seq','$reason','$com_member_id1','$student_id')";
