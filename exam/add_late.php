...
if (isset($_POST['add'])) {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO late (`campus_no`,`room_no`,`date`,`time`,`period`,`year`,`semester`,`course_no`,`section_seq`,`reason`,`com_member_id1`,`confirm`,`student_id`) VALUES" .
            "('$campus_no','$room_no','$date','$time','$period','$year','$semester','$course_no','$section_seq','$reason','$com_member_id1','$confirm','$student_id')";
        ...
        <div class="col-lg-6" style="text-align: right" dir="rtl">
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea name="confirm" rows="3" type="text" class="form-control"></textarea>
                </div>
