...
if (isset($_POST['add'])) {
    ...
    $fields = array(
        ...
        'الفصل الدراسي' => 'semester', 'العام الدراسي' => 'year', 'المقرر' => 'course_no', 'الشعبة' => 'section_seq', 'سبب السماح بالدخول' => 'reason',
    ...
    if (empty($errors)) {
        $sql = "UPDATE forbidden SET `campus_no`='$campus_no',`room_no`='$room_no',`date`='$date',`time`='$time',`period`='$period',`year`='$year',`semester`='$semester',`course_no`='$course_no'
,`section_seq`='$section_seq',`reason`='$reason',`com_member_id1`='$com_member_id1',`student_id`='$student_id' WHERE forbidden_id=$id";
...
<div class="row">
    ...
    <div class="col-lg-6" style="text-align: right" dir="rtl">
        <form action="" method="post">
            ...
            ?>
            <?php
            $sqlMain = "select * from `forbidden` WHERE forbidden_id='$id' limit 1 ";
            ...
            <div class="form-group">
                <label>سبب السماح بالدخول</label>
