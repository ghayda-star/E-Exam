...
if (isset($_POST['add'])) {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO absence (`campus_no`,`room_no`,`date`,`time`,`period`,`year`,`semester`,`course_no`,`section_seq`,`remarks`,`monetor_member_id1`,`monetor_member_id2`,`com_member_id1`,`com_member_id2`,`student_id`) VALUES" .
            "('$campus_no','$room_no','$date','$time','$period','$year','$semester','$course_no','$section_seq','$remarks','$monetor_member_id1','$monetor_member_id2','$com_member_id1','$com_member_id2','$student_id')";
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input name="student_id" id="student_id" type="text" class="form-control" value="<?php if (isset($_POST['student_id'])) {
                                                                                                        ...
                                                                                                        } ?>"><a id="search" class="btn btn-info">بحث</a>
