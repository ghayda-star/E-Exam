...
if (isset($_POST['add'])) {
    ...
    $fields = array(
        ...
        'المشرف' => 'monetor_member_id1', 'المراقب' => 'monetor_member_id2', 'رئيس اللجنة' => 'com_member_id1', 'المرفقات' => 'doc', 'الطالب' => 'student_id'
    );
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO cheating (`campus_no`,`room_no`,`date`,`time`,`period`,`year`,`semester`,`course_no`,`section_seq`,`cheat_case`,`monetor_member_id1`,`monetor_member_id2`,`com_member_id1`,`doc`,`student_id`) VALUES" .
            "('$campus_no','$room_no','$date','$time','$period','$year','$semester','$course_no','$section_seq','$violate_case','$monetor_member_id1','$monetor_member_id2','$com_member_id1','13','$student_id')";
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                   ...
                   <label for="exampleInputEmail1" class="text-dark font-weight-bold">المرفقات</label>
                        <input type="file"  name="doc" class="form-control-file" id="exampleInputFile"  aria-describedby="fileHelp">
                </div>
