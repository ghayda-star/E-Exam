...
if (isset($_POST['add'])) {
    ...
    $fields = array(
        ...
        'الفصل الدراسي' => 'semester', 'العام الدراسي' => 'year', 'المقرر' => 'course_no', 'الشعبة' => 'section_seq', 'المخالفة' => 'violate_case',
        'المشرف' => 'monetor_member_id1', 'المراقب' => 'monetor_member_id2', 'رئيس اللجنة' => 'com_member_id1', 'لجنة الاختبارات' => 'confirm', 'الطالب' => 'student_id'
    );
    ...
    if (empty($errors)) {
        $sql = "UPDATE violating SET `campus_no`='$campus_no',`room_no`='$room_no',`date`='$date',`time`='$time',`period`='$period',`year`='$year',`semester`='$semester',`course_no`='$course_no',
`section_seq`='$section_seq',`violate_case`='$violate_case',`confirm`='$confirm',`monetor_member_id1`='$monetor_member_id1',`monetor_member_id2`='$monetor_member_id2',`com_member_id1`='$com_member_id1',
`student_id`='$student_id' WHERE violation_id=$id";
...
<div class="row" style="margin-top: 150px;text-align: center;margin-bottom: 20px">
    <div class="col-lg-12">
        <h3> استمارة مخالفة نظام لجنة</h3>
...
<div class="row">
    ...
    <div class="col-lg-6" style="text-align: right" dir="rtl">
        <form action="" method="post">
            ...
            ?>
            <?php
            $sqlMain = "select * from `violating` WHERE violation_id='$id' limit 1 ";
            ...
            <div class="form-group">
                ...
                <textarea name="violate_case" rows="3" type="text" class="form-control"><?php if (isset($_POST['violate_case'])) {
                        echo $_POST['violate_case'];
                    }else{ echo $row5['violate_case']; } ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="confirm" rows="3" type="text" class="form-control"><?php if (isset($_POST['confirm'])) {
                        echo $_POST['confirm'];
                    }else{ echo $row5['confirm']; } ?></textarea>
            </div>
