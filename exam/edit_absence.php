...
if (isset($_POST['add'])) {
    ...
    $fields = array(
        ...
        'الفصل الدراسي' => 'semester', 'العام الدراسي' => 'year', 'المقرر' => 'course_no', 'الشعبة' => 'section_seq', 'ملاحظات' => 'remarks',
        'المشرف' => 'monetor_member_id1', 'المراقب' => 'monetor_member_id2', 'رئيس اللجنة' => 'com_member_id1', 'عضو اللجنة' => 'com_member_id2', 'الطالب' => 'student_id'
    );
    ...
    $violate_case = mysqli_real_escape_string($conn, trim($_POST['violate_case']));
    ...
    if (empty($errors)) {
        $sql = "UPDATE absence SET `campus_no`='$campus_no',`room_no`='$room_no',`date`='$date',`time`='$time',`period`='$period',`year`='$year',`semester`='$semester',
`course_no`='$course_no',`section_seq`='$section_seq',`remarks`='$remarks',`monetor_member_id1`='$monetor_member_id1',`monetor_member_id2`='$monetor_member_id2',
`com_member_id1`='$com_member_id1',`com_member_id2`='$com_member_id2',`student_id`='$student_id' WHERE absence_id=$id";
...
<div class="row">
    ...
    <div class="col-lg-6" style="text-align: right" dir="rtl">
        <form action="" method="post">
            ...
            ?>
            <?php
            $sqlMain = "select * from `absence` WHERE absence_id='$id' limit 1 ";
            ...
            ?>
                ...
                <div class="form-group">
                <label>ملاحظات</label>
                <textarea name="remarks" rows="3" type="text" class="form-control"><?php if (isset($_POST['remarks'])) {
                        echo $_POST['remarks'];
                    }else{ echo $row5['remarks']; } ?></textarea>
            </div>
