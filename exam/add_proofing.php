...
if (isset($_POST['add'])) {
    ...
    if (empty($errors)) {
        $sql = "INSERT INTO proofing (`campus_no`,`room_no`,`date`,`time`,`period`,`year`,`semester`,`course_no`,`section_seq`,`reason`,`confirm`,`com_member_id1`,`student_id`) VALUES" .
            "('$campus_no','$room_no','$date','$time','$period','$year','$semester','$course_no','$section_seq','$reason','$confirm','$com_member_id1','$student_id')";
...
<body>
    ...
    <div class="row" style="margin-top: 150px;text-align: center;margin-bottom: 20px">
        <div class="col-lg-12">
            <h3> استمارة عدم إحضار الهوية</h3>
